...
const ParentDashboard = () => {
    ...
    const [linkData, setLinkData] = useState({ schoolCode: '', nni: '' });
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden relative animate-fade-in-down">
                        ...
                        <form onSubmit={handleLinkStudent} className="p-10 space-y-6">
                            ...
                            <div>
                                <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-3">NNI de l'élève</label>
                                <input
                                    type="text"
                                    ...
                                    value={linkData.nni}
                                    onChange={e => setLinkData({ ...linkData, nni: e.target.value })}
                                    required
                                />
                            </div>
