...
async function sendEmail(to, subject, content, senderInfo = {}) {
    ...
    const htmlContent = typeof content === 'string' ? content : `
        <div style="direction: rtl; text-align: right; font-family: Arial, sans-serif; border-bottom: 2px solid #eee; padding-bottom: 20px; margin-bottom: 20px;">
            <div style="text-align: center; margin-bottom: 20px;">
                <img src="cid:logo" alt="Controlleur" style="width: 80px; height: 80px; border-radius: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" />
                <h2 style="color: #4f46e5; margin-top: 10px;">Controlleur - المراقب</h2>
            </div>
        ...
        <div style="direction: ltr; text-align: left; font-family: Arial, sans-serif;">
            ...
            <p style="color: #666; font-size: 12px; text-align: center;">
                &copy; ${new Date().getFullYear()} Controlleur. Tous droits réservés.
            </p>
        </div>
    `;

    try {
        const fromName = senderInfo.name || "Controlleur";
        ...
        const mailOptions = {
            ...
            attachments: [{
                filename: 'logo.jpeg',
                path: path.resolve(__dirname, '../../../Surveilleur.jpeg'),
